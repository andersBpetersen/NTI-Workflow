...
docker push tickjf/nti-workflow:0.7.1
```

Valgfrit — push også `latest`:

```powershell
docker tag tickjf/nti-workflow:0.7.1 tickjf/nti-workflow:latest
...
Giver: `registry.example.com/nti/nti-workflow:0.7.1`
...
Erstat `0.7.1` med den nye version ved næste release.
...
- Brug versions-tags (`0.7.1`) som primær reference i drift
